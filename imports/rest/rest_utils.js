...
export const FLOWCHART_ALL_USR_ID   = "all_usr_id";
export const FLOWCHART_COMMENTS     = "comments";
export const FLOWCHART_SCORE        = "score";
export const FLOWCHART_UPVOTES   = "upvotes";
export const FLOWCHART_DOWNVOTES = "downvotes";
...
export const formatChartForREST = function (rawChart) {
    ...
    chart[FLOWCHART_UPVOTES]   = rawChart[Charts.UPVOTED_IDS].length;
    chart[FLOWCHART_DOWNVOTES] = rawChart[Charts.DOWNVOTED_IDS].length;
